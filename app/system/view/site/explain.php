...
<block name="content">
	...
	<ul class="nav nav-tabs nav-justified">
		...
		<li role="presentation" class="active"><a href="?s=system/site/wechat&step=explain&siteid={{SITEID}}">微信平台设置信息</a></li>
	</ul>
		...
		<div class="panel-body">
			...
			<ul class="list-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<p class="form-control-static copy">
									<a href="javascript:;" class="text-info copy">{{__ROOT__}}/index.php?http://dev.hdcms.com/index.php?s=site/api/handle&siteid={{$wechat['siteid']}}</a>
								</p>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<p class="form-control-static">
									<a href="javascript:;" class="text-info copy">{{$wechat['token']}}</a>
								</p>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<p class="form-control-static">
									<a href="javascript:;" class="text-info copy">{{$wechat['encodingaeskey']}}</a>
								</p>
							</div>
						</div>
					</form>
				...
				<li class="list-group-item">
					...
					<button class="btn btn-success" onclick="checkConnect();">检测公众号【{{$wechat['wename']}}】是否接入成功</button>
...
<script>
	...
	function checkConnect() {
		$.get("?s=system/site/connect&siteid={{SITEID}}", function (res) {
			if (res.valid) {
