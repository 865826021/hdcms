...
<block name="content">
    ...
    <form action="" class="form-horizontal" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <p class="form-control-static">
                    <strong class="text-danger">开始时间：{{date('Y-m-d',$user['starttime'])}}~~ 到期时间：{{date('Y-m-d',$user['endtime'])}}</strong>
                </p>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="endtime" value="{{date('Y-m-j',$user['endtime'])}}" id="datetimepicker" class="form-control" >
