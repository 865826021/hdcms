        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="smtp[host]" value="{{v('site.setting.smtp.host')}}">
                        <span class="help-block">指定SMTP服务器的地址, 如: smtp.126.com</span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">SMTP服务器端口</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="smtp[port]" value="{{v('site.setting.smtp.port')}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="smtp[username]" value="{{v('site.setting.smtp.username')}}">
                        <span class="help-block">指定发送邮件的用户名，例如：test@126.com</span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="smtp[fromname]" value="{{v('site.setting.smtp.fromname')}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="smtp[frommail]" value="{{v('site.setting.smtp.frommail')}}">
                        <span class="help-block">指定发送邮件发信人名称</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="smtp[testusername]" value="{{v('site.setting.smtp.testusername')}}">
