...
# Database: hdcms
# Generation Time: 2017-01-21 06:29:30 +0000
# ************************************************************
...
VALUES
	...
	(89,100,'系统管理','','','','fa fa-cubes',0,1,0,'feature'),
	(90,89,'更新站点缓存','system_update_cache','?s=site/system/updateCache','','fa fa-cubes',0,1,0,'feature'),
...
VALUES
	(1,13,'hdcms',1,'{\"csrf_token\":\"a27029673cce8344c2a5b9345375e30a\",\"title\":\"ssss\"}');
...
VALUES
	('hdphp321b86cac8005345983f91bbe9ad20f29277','a:3:{s:10:\"csrf_token\";s:32:\"e62ceb74f33fd01da4c7967eda80b801\";s:9:\"admin_uid\";s:1:\"1\";s:6:\"siteid\";i:13;}',1484980144);
