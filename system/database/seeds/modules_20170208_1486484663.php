...
VALUES
	...
	(3,'article','business','文章系统','1.0','发布文章与会员中心管理','支持桌面、移动、微信三网的文章系统，同时具有移动、桌面会员中心管理功能','后盾','http://www.hdcms.com','1','','',0,0,0,0,0,'','thumb.jpg','cover.jpg',0,''),
	(4,'setting','business','网站配置','1.0','网站运行整体配置','网站运行配置项，如支付、邮箱、登录等等的全局配置项管理','后盾','http://www.hdcms.com','1','','',0,0,0,0,0,'','thumb.jpg','cover.jpg',0,''),
	(5,'member','business','会员粉丝','1.0','会员管理','会员与会员组管理，如会员字段，粉丝管理、会员卡设置','后盾','http://www.hdcms.com','1','','{\"subscribe\":true}',0,0,0,0,0,'','thumb.jpg','cover.jpg',0,''),
	(6,'special','business','微信默认消息','1.0','微信默认消息','系统默认消息与关注微信消息处理','后盾','http://www.hdcms.com','1','','',0,0,0,0,0,'','thumb.jpg','cover.jpg',0,''),
	(7,'ticket','business','卡券管理','1.0','会员卡券管理','会员优惠券、代金券、实物券管理','后盾','http://www.hdcms.com','1','','',0,0,0,0,0,'','thumb.jpg','cover.jpg',0,''),
	(8,'cover','business','封面回复','1.0','封面消息回复','用来处理模块的封面消息','后盾','http://www.hdcms.com','1','','{\"text\":true}',0,0,0,0,0,'','thumb.png','cover.jpg',0,''),
	...
	(1000,'quicknavigate','business','快捷菜单','1.0','站点管理中的快捷菜单操作','用在后台底部快捷导航菜单的管理操作功能','后盾','http://www.hdcms.com','1','','',0,0,0,0,0,'','thumb.jpg','cover.jpg',0,'');
str;
		Db::execute($sql);
	}
    //回滚
