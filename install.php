	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="col-xs-9">
				...
				<a href="index.php/hdcms" class="btn btn-success btn-block btn-lg">登录系统</a>
			</div>
		</div>
	</div>
...
<script>
    ...
    function error() {
        alert('当前下载量太大,暂时无法提供下载,你可以尝试刷新页面,或直接去官网下载离线安装包');
        clearInterval(tid);
//        window.history.back();
    }
</script>
str;
$databaseTemplate=<<<str
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label class="checkbox-inline">
                                        <input type="checkbox" name="replace_database" value="1"/> 重建数据库
                                        <span class="help-block">如果数据库存在时清空数据库中的表，请慎重选择！</span>
                                    </label>
                                </div>
                            </div>
                        </div>
