	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			<div class="navbar-header">
				<ul class="nav navbar-nav" id="top_menu" ng-controller="topMenuController">
					<li>
		...
		<div class="col-xs-12 col-sm-3 col-lg-2 left-menu">
			...
			<div class="panel panel-default">
				...
				<if value="v('module.title') && v('module.is_system')==0">
					...
					<if value="$_COOKIE['ext_menu_type']==2">
				...
				<!--扩展模块动作 end-->
				<!--模块列表-->
				<if value="isset($MODULES_MENU)">
					<foreach from="$MODULES_MENU" key="$t" value="$d">
						...
						<ul class="list-group menus collapse in module_menu">
							<foreach from="$d" value="$g">
								<li class="list-group-item" data-type="module_menu" data-href="?s=package/module/home&m={{$g['name']}}">
									{{$g['title']}}
								</li>
							</foreach>
						</ul>
