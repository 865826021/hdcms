...
<head>
    ...
    <script>
        window.system = {
            ...
            url:"http://localhost/hdcms/index.php?s=core/user/edit&uid=19",
        }
    </script>
    <script>
...
<body class="hdcms">
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="<?php echo __URL__?>">编辑用户</a></li>
        <li role="presentation"><a href="<?php echo u('permission',array('uid'=>$_GET['uid']))?>">查看用户权限</a></li>
    </ul>
    ...
    <form action="" class="form-horizontal" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <span class="form-control"><?php echo $user['username']?></span>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <strong class="text-danger">开始时间：<?php echo date('Y-m-d',$user['starttime'])?>~~ 到期时间：<?php echo date('Y-m-d',$user['endtime'])?></strong>
              </p>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" value="2015-12-1 21:05" hd-datetimepicker class="form-control" name="endtime">
                <span class="help-block">设置到期时间，留空为不限制. <a href="javascript:;" class="text-primary" onclick="$(this).parent().prev().val('')">清空</a></span>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" rows="3" name="remark"><?php echo $user['remark']?></textarea>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <span class="form-control"><?php echo date('Y-m-d',$user['lasttime'])?></span>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <span class="form-control"><?php echo $user['lastip']?></span>
            </div>
        </div>

        <h5 class="page-header">编辑用户基本资料</h5>
        <?php foreach ((array)$userField as $f){?>
        <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $f['title']?>
            <?php if($f['required']){?>
            ...
            <div class="col-sm-10">
                <?php if(empty($profile)){?>
                    ...
                    <input type="text" class="form-control" name="<?php echo $f['field']?>" value="">
                    <?php }else{?>
                    <input type="text" class="form-control" name="<?php echo $f['field']?>" value="<?php echo $profile[$f['field']]?>">
