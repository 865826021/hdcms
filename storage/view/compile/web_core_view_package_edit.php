...
<body class="hdcms">
    ...
    <ul class="nav nav-tabs">
        <li role="presentation"><a href="<?php echo u('lists')?>">服务套餐列表</a></li>
        <li role="presentation"><a href="<?php echo u('accretion')?>">添加套餐</a></li>
        <li role="presentation" class="active"><a href="<?php echo u('accretion')?>">编辑套餐</a></li>
    </ul>
    <div class="clearfix">
        <div class="form-group">
            <form class="form-horizontal" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="name" class="form-control" value="<?php echo $field['name']?>">
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <?php foreach ((array)$modules as $p){?>
                                <tr>
                                    <td><input type="checkbox" name="name" checked disabled></td>
