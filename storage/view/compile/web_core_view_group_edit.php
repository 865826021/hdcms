...
<body class="hdcms">
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="<?php echo u(__URL__)?>">编辑用户组</a></li>
    </ul>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="maxsite" value="<?php echo $group['maxsite']?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="text" class="form-control" name="daylimit" value="<?php echo $group['daylimit']?>">
            ...
            <div class="panel-body table-responsive">
                <table class="table table-hover">
                    ...
                    <?php foreach ((array)$packages as $p){?>
                        <tr>
                            <td>
                                <?php if(array_search($p['id'],$group['package'])===false){?>
                
                                    <input type="checkbox" name="package[]" value="<?php echo $p['id']?>">
                                    <?php }else{?>
                                    <input type="checkbox" name="package[]" value="<?php echo $p['id']?>" checked>
               ...
               <?php }?>
                    ...
                    <tr>
                        <td>
                            <?php if(in_array(-1,$group['package'])){;?>
                            <input type="checkbox" name="package[]" value="-1" checked>
                            <?php }else{;?>
