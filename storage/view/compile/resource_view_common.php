                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">
                                ...
                                <?php echo session::get('user.username')?>(<?php echo session::get('user.role')?>)
    ...
    <div class="container-fluid" style="margin-top: 30px;margin-bottom: 20px;">
        ...
        <div class="col-md-6">
            <ul class="nav nav-pills pull-right">
                <li>
                    <a href="?s=core/site/lists" class="tile <?php if(" CONTROLLER"=="syddstem"){?>
                active
               <?php }?>">
                ...
                <li>
                    <a href="?s=core/system/index" class="tile <?php if(" CONTROLLER"=="system"){?>
                active
               <?php }?>">
