...
<head>
    ...
    <script>
        window.system = {
            ...
            url:"http://localhost/hdcms/index.php?s=core/user/permission&uid=19",
        }
    </script>
    <script>
...
<body class="hdcms">
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation"><a href="<?php echo u('edit',array('uid'=>$_GET['uid']))?>">编辑用户</a></li>
        <li role="presentation" class="active"><a href="#">查看操作权限</a></li>
    </ul>
    <div class="panel panel-default">
        <div class="panel-heading">
            <p class="panel-title">用户组基本权限</p>
        </div>
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td width="300"><?php echo $group['name']?> <a href="<?php echo u('group/edit',array('id'=>$group['id']))?>"><span class="fa fa-edit"></span></a></td>
                    <td></td>
                </tr>
                <tr>
                    <td>最多站点数量</td>
                    <td><?php echo $group['maxsite']?></td>
                    <td></td>
                </tr>
                </tbody>
            </table>
            ...
            <table class="table table-hover">
                ...
                <?php foreach ((array)$sites as $s){?>
                    <tr>
                        ...
                        <td>
                            <a href="">编辑站点</a>&nbsp;|&nbsp;
                            <a href="?s=core/permission/users&siteid=<?php echo $s['siteid']?>&fromuid=<?php echo $_GET['uid']?>">编辑权限</a>
                        </td>
                    </tr>
                <?php }?>
                </tbody>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">当前用户所在用户组可使用的站点权限</h3>
        </div>
        <div class="panel-body">
            <table class="table table-hover">
                <thead>
                    ...
                    <?php foreach ((array)$packages as $p){?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if(!empty($p['modules_title'])){?>
                
                                    <?php foreach ((array)$p['modules_title'] as $mt){?>
                                        <span class="label label-info"><?php echo $mt?></span>
                                    <?php }?>
