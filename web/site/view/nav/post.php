...
<block name="content">
    <ul class="nav nav-tabs" role="tablist">
        <li><a href="?s=article/manage/site">返回站点列表</a></li>
        <li><a href="?s=site/nav/lists&entry={{$_GET['entry']}}">导航菜单列表</a></li>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group" style="width: 340px;">
                                ...
                                <span class="input-group-addon" id="basic-addon1" ng-style="{width: '40px','border-left':'none',background:field.css.color}"></span>
                                <div class="input-group-btn">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="input-group" style="margin-top:5px;" ng-if="field.css.image">
                                ...
                                <em class="close" style="position:absolute; top: 0px; right: -14px;" title="删除这张图片" ng-click="removeImageIcon()">×</em>
                            </div>
                        </div>
                    </div>
                </div>
