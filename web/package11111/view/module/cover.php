...
<block name="content">
    ...
    <form action="" method="post" class="form-horizontal ng-cloak" role="form" id="replyForm" ng-controller="ctrl">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">封面名称</label>
                    <div class="col-sm-7 col-md-8">
                        <input type="text" class="form-control" name="name" value="{{$field['name']}}" readonly="readonly">
                    ...
                    <div class="col-sm-3 col-md-2">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="" ng-model="reply.advSetting">高级设置
                            </label>
                        </div>
                    </div>
                </div>
                <include file="web/resource/view/keyword"/>
                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                <button onclick="upImage(this)" class="btn btn-default" type="button" onclick="upImage(this)">选择图片</button>
                                            </div>
                                        </div>
