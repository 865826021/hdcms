...
<div class="link-ceil">
    <div id="link-btns">
        ...
        <div>
            ...
            <div class="btn btn-default" onclick="selectLink('?s=uc/ticket/lists&i={{$_SESSION['siteid']}}&type=2&status=1')">我的折扣券</div>
            <div class="btn btn-default" onclick="selectLink('?s=uc/ticket/lists&i={{$_SESSION['siteid']}}&type=1&status=1')">我的代金券</div>
            <div class="btn btn-default" onclick="selectLink('?s=uc/entry/changeMobile&i={{$_SESSION['siteid']}}">修改手机号</div>
            <div class="btn btn-default" onclick="selectLink('?s=uc/address/lists&i={{$_SESSION['siteid']}}')">修改收货地址</div>
        </div>
    </div>
</div>
