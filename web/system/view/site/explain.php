    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    <h5 class="page-header">公众号 <strong class="text-info">{{$wechat['wename']}}</strong> 正在等待接入……请及时按照以上步骤操作接入公众平台</h5>
...
<script>
    ...
    function checkConnect() {
        $.get("?s=system/site/connect&siteid={{$_GET['siteid']}}", function (res) {
            if (res.valid) {
