    ...
    <div class="clearfix">
        ...
        <form action="" id="form" class="form-horizontal form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-xs-12">
                    <input type="number" class="form-control" placeholder="" name="version">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-xs-12">
                    ...
                    <span class="help-block"><strong>注意:桌面个人中心导航扩展功能定义于 site 类中</strong></span>
                </div>
            </div>
...
开发者必须要完善 processor.php 类文件中的 public function respond(){} 方法</span>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-xs-12">
                    ...
                    <span class="help-block"><strong>注意: 规则列表扩展功能定义于 site 类的实现中</strong></span>
                </div>
            </div>
            <!--业务功能-->
...
权限标识由：控制器名和方法名组成。例如,添加商品：shop_add"。例如，控制器名称为：shop,方法为：add,则对应标识为：shop_add
,多个权限标识使用换行隔开。模块方法中使用api('module')->auth('show_add')进行权限验证
                    </span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10 col-xs-12">
                    ...
                    <span class="help-block"><strong>注意: 业务功能菜单定义于 site 类的实现中</strong></span>
                </div>
            </div>
            <!--微站首页导航-->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-xs-12">
                    ...
                    <span class="help-block">用 48*48 的图片来让你的模块更吸引眼球吧,图片类型必须为jpg</span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10 col-xs-12">
                    ...
                    <span class="help-block">模块封面, 大小为 600*350, 更好的设计将会获得官方推荐位置,图片类型必须为jpg</span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 col-xs-12">
                    ...
                    <input type="submit" class="btn btn-primary" id="createBtn" name="submit" onclick="$(':hidden[name=method]').val('create');" value="生成模块模板">
...
<script>
    ...
    $("form").submit(function () {
        ...
        $(".bootstrap-filestyle input").each(function () {
            if (!/jpeg|jpg$/i.test($(this).val())) {
                msg += "["+$(this).parent().parent().prev().text()+"] 图片类型必须为jpg<br/>";
            }
        })
        if (msg) {
